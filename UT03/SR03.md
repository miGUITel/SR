...
[2. Sistemas de Nombres Planos](#2-sistemas-de-nombres-planos)
[3. Sistemas de Nombres Jerárquicos](#3-sistemas-de-nombres-jerárquicos)
[4. Consultas DNS](#4-consultas-dns)
[5. Tipos de Servidores DNS](#5-tipos-de-servidores-dns)
[6. Zonas de Resolución Directa e Inversa](#6-zonas-de-resolución-directa-e-inversa)
[7. Registros DNS](#7-registros-dns)
[8. Actualizaciones Dinámicas (DDNS)](#8-actualizaciones-dinámicas-ddns)
[9. DNS Seguro (DNSSEC)](#9-dns-seguro-dnssec)
[10. Cliente DNS (Resolver)](#10-cliente-dns-resolver)
