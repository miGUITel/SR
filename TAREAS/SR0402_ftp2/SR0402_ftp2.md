...
## **2. Configurar Usuarios en el Administrador de Usuarios del Servidor**
   - **2.0.** Confirmar que existe el usuario **Anonymous**:
...
## **3. Comprobar la Configuración con FileZilla**
   ...
   - **3.2.** Conectar al servidor FTP como **AdminFTP**:
     ...
     - En la parte superior de la interfaz, localizar la barra de conexión rápida, donde se introducen los datos del servidor.
       ...
       - **Nombre de Usuario**: Escribir `nombreHostVirtual|AdminFTP`.
...
- Captura del gestor de FTP de WS19 en la que se muestre que tienes dos sitios FTP creados, llama a la captura nombre1.png
- Captura de una conexión desde FileZilla utilizando un usuario llamado como tú, a uno de los sitios. También se debe apreciar cómo puedes subir un archivo al servidor FTP, llama a la captura nombre2.png 
- Captura de una conexión desde FileZilla utilizando el usuario anónimo. También se debe apreciar cómo **NO** puedes subir un archivo al servidor FTP, llama a la captura nombre3.png