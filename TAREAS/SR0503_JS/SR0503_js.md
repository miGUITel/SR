- [Práctica: Ejecutar un Script de JavaScript desde un Archivo Externo](#práctica-ejecutar-un-script-de-javascript-desde-un-archivo-externo)
    - [Paso 1: Crear el Archivo HTML](#paso-1-crear-el-archivo-html)
    - [Paso 2: Crear el Archivo JavaScript](#paso-2-crear-el-archivo-javascript)
    - [Paso 3: Subir los Archivos al Servidor](#paso-3-subir-los-archivos-al-servidor)
    - [Paso 4: Acceder a la Página en el Navegador](#paso-4-acceder-a-la-página-en-el-navegador)
    - [Captura a entregar](#captura-a-entregar)
...
A la izquierda arriba: Directorio con los archivos .html y .js creados
A la izquierda abajo: contenido del .js.
A la derecha: acceso desde el navegador a la página en la que se vea lo que sucede cuando pulsas el botón.
